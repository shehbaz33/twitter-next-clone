...
import { collection, deleteDoc, doc, onSnapshot, query, setDoc, orderBy } from "firebase/firestore";
...
const Post = ({ id,post,postPage }) => {
  ...
  return <div className='p-3 flex cur border-b border-gray-700' onClick={() => router.push(`/${id}`)}>
       {!postPage && (
       ...
       <div className='flex flex-col space-y-2 w-full'>
        ...
        <img src={post?.Image} alt="" srcset="" className='rounded-2xl max-h-[700px] object-cover mr-2' />
